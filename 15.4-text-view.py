...
class SearchDialog(Gtk.Dialog):
    ...
    def __init__(self, parent):
        ...
        Gtk.Dialog.__init__(
            ...
            buttons=(Gtk.STOCK_FIND, Gtk.ResponseType.OK, Gtk.STOCK_CANCEL, Gtk.ResponseType.CANCEL)
            )
...
class TextViewWindow(Gtk.Window):
    ...
    def create_toolbar(self):
        ...
        radio_justifyright = Gtk.RadioToolButton.new_with_stick_from_widget(radio_justifyleft, Gkt.STOCK_JUSTIFY_RIGHT)
        toolbar.insert(radio_justifyright, 6)

        radio_justifyfill = Gtk.RadioToolButton.new_with_stick_from_widget(radio_justifyleft, Gkt.STOCK_JUSTIFY_FILL)
        toolbar.insert(radio_justifyfill, 7)

        radio_justfyleft.connect("toggled", self.on_justify_toggled, Gtk.Justification.LEFT)
        radio_justfycenter.connect("toggled", self.on_justify_toggled, Gtk.Justification.CENTER)
        radio_justfyright.connect("toggled", self.on_justify_toggled, Gtk.Justification.RIGHT)
        radio_justfyfill.connect("toggled", self.on_justify_toggled, Gtk.Justification.FILL)
    ...
    def create_buttons(self):
        ...
        self.grid.attach_next_to(check_cursor, check_editable, Gtk.PositionType.RIGHT, 1, 1)
        ...
        self.grid.attach_next_to(radio_wrapchar, radio_wrapnone, Gtk.PositionType.RIGHT, 1, 1)

        radio_wrapword = Gtk.RadioButton.new_with_label_from_widget(radio_wrapchar, "Word Wrapping")
        self.grid.attach_next_to(radio_wrapword, radio_wrapchar, Gtk.PositionType.RIGHT, 1, 1)
