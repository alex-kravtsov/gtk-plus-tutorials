...
class EntryWindow(Gtk.Window):
    ...
    def __init__(self):
        ...
        self.check_pulse = Gtk.CheckButton("Pulse")
        self.check_pulse.connect("toggled", self.on_pulse_toggled)
        self.check_pulse.set_active(False)
        hbox.pack_start(self.check_pulse, True, True, 0)

        self.check_icon = Gtk.CheckButton("Icon")
        self.check_icon.connect("toggled", self.on_icon_toggled)
        self.check_icon.set_active(False)
        hbox.pack_start(self.check_icon, True, True, 0)
